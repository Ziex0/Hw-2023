...
float Player::GetManaBonusFromIntellect()
{
    ...
    float baseInt = std::min(15.0f, intellect);
...
void Player::UpdateManaRegen()
{
    ...
    float power_regen_mp5 = (GetTotalAuraModifierByMiscValue(SPELL_AURA_MOD_POWER_REGEN, POWER_MANA) + m_baseManaRegen) / 3.0f;
