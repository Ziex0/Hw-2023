...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_int_configs[CONFIG_RATE_XP_WEEKEND_EVID]	= ConfigMgr::GetIntDefault("Rate.XP.Weekend.EVID", 65.0f);
	...
	m_int_configs[CONFIG_FAKE_WHO_ONLINE_INTERVAL]  = ConfigMgr::GetIntDefault("Fake.WHO.Online.Interval", 7);
	...
	// Stats limits
    m_bool_configs[CONFIG_STATS_LIMITS_ENABLE] = ConfigMgr::GetBoolDefault("Stats.Limits.Enable", true);
    m_float_configs[CONFIG_STATS_LIMITS_DODGE] = ConfigMgr::GetFloatDefault("Stats.Limits.Dodge", 35.0f);
    m_float_configs[CONFIG_STATS_LIMITS_PARRY] = ConfigMgr::GetFloatDefault("Stats.Limits.Parry", 35.0f);
    m_float_configs[CONFIG_STATS_LIMITS_BLOCK] = ConfigMgr::GetFloatDefault("Stats.Limits.Block", 35.0f);
    m_float_configs[CONFIG_STATS_LIMITS_CRIT]  = ConfigMgr::GetFloatDefault("Stats.Limits.Crit", 37.0f);
