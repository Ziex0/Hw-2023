       ...
       if(Plr->GetSession())
        {
            ...
            Plr->ADD_GOSSIP_ITEM( GOSSIP_ICON_DOT, "|cff00ff00|TInterface\\icons\\Achievement_Boss_Valanar:24|t|rChange me Into Human", 0, 1 );
            Plr->ADD_GOSSIP_ITEM( GOSSIP_ICON_DOT, "|cff00ff00|TInterface\\icons\\Achievement_Boss_Valanar:24|t|rChange me Into NightElf", 0, 4 );
            Plr->ADD_GOSSIP_ITEM( GOSSIP_ICON_DOT, "|cff00ff00|TInterface\\icons\\Achievement_Boss_Valanar:24|t|rChange me Into Dwarf", 0, 3 );
            Plr->ADD_GOSSIP_ITEM( GOSSIP_ICON_DOT, "|cff00ff00|TInterface\\icons\\Achievement_Boss_Valanar:24|t|rChange me Into Gnome", 0, 7 );
            Plr->ADD_GOSSIP_ITEM( GOSSIP_ICON_DOT, "|cff00ff00|TInterface\\icons\\Achievement_Boss_Valanar:24|t|rChange me Into Draenei", 0, 11 );
            Plr->ADD_GOSSIP_ITEM( GOSSIP_ICON_DOT, "|cff00ff00|TInterface\\icons\\Achievement_Boss_Valanar:24|t|rChange me Into Orc", 0, 2 );
            Plr->ADD_GOSSIP_ITEM( GOSSIP_ICON_DOT, "|cff00ff00|TInterface\\icons\\Achievement_Boss_Valanar:24|t|rChange me Into Undead", 0, 5 );
            Plr->ADD_GOSSIP_ITEM( GOSSIP_ICON_DOT, "|cff00ff00|TInterface\\icons\\Achievement_Boss_Valanar:24|t|rChange me Into Tauren", 0, 6 );
            Plr->ADD_GOSSIP_ITEM( GOSSIP_ICON_DOT, "|cff00ff00|TInterface\\icons\\Achievement_Boss_Valanar:24|t|rChange me Into Troll", 0, 8 );
			Plr->ADD_GOSSIP_ITEM( GOSSIP_ICON_DOT, "|cff00ff00|TInterface\\icons\\Achievement_Boss_Valanar:24|t|rChange me Into Blood Elf", 0, 10 );
			Plr->ADD_GOSSIP_ITEM( GOSSIP_ICON_DOT, "|cff00ff00|TInterface\\icons\\Achievement_Boss_Valanar:24|t|rChange me Into Worgen", 0, 21 );
			Plr->ADD_GOSSIP_ITEM( GOSSIP_ICON_DOT, "|cff00ff00|TInterface\\icons\\Achievement_Boss_Valanar:24|t|rChange me Into Goblin", 0, 9 );
